...
<link rel="stylesheet" type="text/css" href="style2.css">
           ...
           <div class="container" style="width:700px;" align="center">  
                <h3 align="center">LETTERS</h3><br />  
		<?php  
                $query = "SELECT * FROM letter ORDER BY id ASC";  
                ...
                <div  class="col-md-4"  >  
                     <form  method="post" action="cart.php?action=add&id=<?php echo $row["id"] ;  ?>">  
                          <div style="border:1px solid #555; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">  
                               ...
                               <input type="submit" name="add_to_cart1" style="margin-top:5px;" class="btn btn-success" value="Add To Cart" /> 
